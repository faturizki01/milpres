    ...
    <div className="min-h-screen bg-gray-50 p-4 md:p-8">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600 mt-1">Tambahkan artikel atau berita baru ke situs Anda</p>
        </div>
        ...
        <form className="space-y-8" onSubmit={(e) => { e.preventDefault(); handleSave(); }}>
          ...
          <div className="bg-white rounded-lg shadow-sm p-6">
            ...
            <div className="mb-6">
              ...
              <p className="text-xs text-gray-500 mt-1">URL untuk artikel, auto-generate dari judul</p>
            </div>
          ...
          <div className="flex gap-4">
            ...
            >
              {loading ? 'Menyimpan...' : `Simpan sebagai ${formData.status}`}
            </button>
            <button
              type="button"
